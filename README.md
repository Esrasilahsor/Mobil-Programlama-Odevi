...
Bu proje, Android Studio ile geliştirilmiş basit bir not alma uygulamasıdır. Kullanıcılar başlık ve içerik girerek yeni notlar oluşturabilir, kaydedilen notları liste halinde görebilir, istediği nota tıklayarak detaylarını okuyabilir ve notun üzerine uzun süre basarak notu silebilir.
